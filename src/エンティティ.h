...
namespace エンジン 
{
	...
	public:
		システムサービス(エンティティサービス& エンティティサービス,
						 レンダリングサービス& レンダラー,
						 入力サービス& 入力,
						 弾丸サービス& 弾丸,
						 背景& 背景):
	...
	//追加
	class 背景コンポーネント final :public コンポーネント {
	private:
		TCHAR* 名前_ = L"背景コンポーネント";
		背景& 背景_;
	public:
		背景コンポーネント(エンティティ& 親) : コンポーネント(親),
			背景_(システムサービス_->背景取得()){}
		~背景コンポーネント(){}
	...
	//追加
	class 背景・エンティティ final :public エンティティ {
	private:
		スプライトコンポーネント* スプライト_;
	public:
		背景・エンティティ();
